...
bx_err_t set_general_io( u8 pin_num, u8 type )
{
    switch( pin_num ) {
        case 0:
            bxd_iomux_af_enable( GPIO00_EN );
            break;
        case 1:
            bxd_iomux_af_enable( GPIO01_EN );
            break;

        case 2:
            bxd_iomux_af_disable( FUNC_IO_EN00 );
            bxd_iomux_af_disable( SPIM0_CS1_EN );
            break;

        case 3:
            bxd_iomux_af_disable( FUNC_IO_EN01 );
            bxd_iomux_af_disable( SPIM0_EN );
            bxd_iomux_af_disable( SPIS_EN );
            break;

        case 4:
            bxd_iomux_af_disable( FUNC_IO_EN02 );
            bxd_iomux_af_disable( SPIM0_EN );
            bxd_iomux_af_disable( SPIS_EN );
            break;

        case 5:
            bxd_iomux_af_disable( FUNC_IO_EN03 );
            bxd_iomux_af_disable( SPIM0_EN );
            bxd_iomux_af_disable( SPIS_EN );
            break;

        case 6:
            bxd_iomux_af_disable( FUNC_IO_EN04 );
            bxd_iomux_af_disable( SPIM0_EN );
            bxd_iomux_af_disable( SPIS_EN );
            break;

        case 7:
            bxd_iomux_af_disable( FUNC_IO_EN05 );
            bxd_iomux_af_disable( BLE_MAC_DBG_EN0 );
            bxd_iomux_af_disable( SPIM1_CS1_EN );
            bxd_iomux_af_disable( RFIF_EN );
            break;

        case 8:
            bxd_iomux_af_disable( SPIM1_EN );
            bxd_iomux_af_disable( BLE_MAC_DBG_EN1 );
            bxd_iomux_af_disable( FUNC_IO_EN06 );
            bxd_iomux_af_disable( RFIF_EN );
            break;
        case 9:
            bxd_iomux_af_disable( SPIM1_EN );
            bxd_iomux_af_disable( BLE_MAC_DBG_EN2 );
            bxd_iomux_af_disable( FUNC_IO_EN07 );
            bxd_iomux_af_disable( RFIF_EN );
            break;
        case 10:
            bxd_iomux_af_disable( SPIM1_EN );
            bxd_iomux_af_disable( BLE_MAC_DBG_EN3 );
            bxd_iomux_af_disable( FUNC_IO_EN08 );
            bxd_iomux_af_disable( RFIF_EN );
            break;
        case 11:
            bxd_iomux_af_disable( SPIM1_EN );
            bxd_iomux_af_disable( BLE_MAC_DBG_EN4 );
            bxd_iomux_af_disable( FUNC_IO_EN09 );
            bxd_iomux_af_disable( RFIF_EN );
            break;

        /* 根据《pin_share.docx》，GPIO14_EN\GPIO15_EN 实际对应 P12 P13 */
        case 12:
            bxd_iomux_af_enable( GPIO14_EN );
            break;
        case 13:
            bxd_iomux_af_enable( GPIO15_EN );
            break;
        case 14:
            bxd_iomux_af_disable( BLE_MAC_DBG_EN7 );
            bxd_iomux_af_disable( FUNC_IO_EN12 );
            bxd_iomux_af_disable( RFIF_EN );
            break;

        case 15:
            bxd_iomux_af_disable( FUNC_IO_EN13 );
            bxd_iomux_af_disable( RFIF_EN );
            break;

        case 16:
            bxd_iomux_af_disable( FUNC_IO_EN14 );
            bxd_iomux_af_disable( RFIF_EN );
            break;

        case 17:
            bxd_iomux_af_disable( FUNC_IO_EN15 );
            bxd_iomux_af_disable( RFIF_EN );
            break;
        case 18:
            bxd_iomux_af_disable( FUNC_IO_EN16 );
            bxd_iomux_af_disable( RFIF_EN );
            break;
        case 19:
            bxd_iomux_af_disable( FUNC_IO_EN17 );
            bxd_iomux_af_disable( RFIF_EN );
            break;
        case 20:
            bxd_iomux_af_disable( FUNC_IO_EN18 );
            bxd_iomux_af_disable( RFIF_EN );
            break;
        case 21:
            bxd_iomux_af_disable( FUNC_IO_EN19 );
            bxd_iomux_af_disable( RFIF_EN );
            break;
        case 22:
            bxd_iomux_af_disable( FUNC_IO_EN20 );
            bxd_iomux_af_disable( RFIF_EN );
            break;
        case 23:
            bxd_iomux_af_disable( FUNC_IO_EN21 );
            break;

        case 24:
        case 25:
        case 26:
            bxd_iomux_af_disable( QSPI_EN0 );
            break;

        case 27:
            bxd_iomux_af_disable( QSPI_EN1 );
            break;

        case 28:
            bxd_iomux_af_disable( QSPI_EN2 );
            break;

        case 29:
            bxd_iomux_af_disable( QSPI_EN3 );
            break;
