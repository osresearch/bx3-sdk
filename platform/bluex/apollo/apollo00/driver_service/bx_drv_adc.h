...
#ifndef __BX_DRV_ADC_H__
#define __BX_DRV_ADC_H__
...
bx_err_t    bx_drv_adc_get_battery(void * hdl, u32* value );
bx_err_t    bx_drv_adc_get_chip_temperature(void * hdl, u32* value );
