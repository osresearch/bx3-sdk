...
#ifndef __BXD_SPIM_H__
#define __BXD_SPIM_H__
...
bx_err_t    bxd_spim_read( void * hdl,u8 * buff, u32 len );
bx_err_t    bxd_spim_write( void * hdl,u8 * buff, u32 len );
