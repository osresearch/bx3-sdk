...
#else
#define rwip_rf (*(struct rwip_rf_api *)jump_table[RWIP_RF])
#endif
...
#else
#define rwip_priority ((struct rwip_prio *)jump_table[RWIP_PRIORITY])
#define rwip_coex_cfg ((uint8_t *)jump_table[RWIP_COEX_CFG])
#endif
...
#else
typedef void (*rwip_reset_fn)();
#define rwip_reset() ((rwip_reset_fn)jump_table[RWIP_RESET])()
#endif
/**
 ****************************************************************************************
...
#else
typedef void (*rwip_wakeup_fn)(void);
#define rwip_wakeup() ((rwip_wakeup_fn)jump_table[RWIP_WAKEUP])()
#endif
...
void rwip_wakeup_end(void);
 #else
 typedef void (*rwip_wakeup_end_fn)(void);
 #define rwip_wakeup_end() ((rwip_wakeup_end_fn)jump_table[RWIP_WAKEUP_END])()
 #endif
...
#else
typedef void (*rwip_prevent_sleep_set_fn)(uint16_t);
#define rwip_prevent_sleep_set(prv_slp_bit) ((rwip_prevent_sleep_set_fn)jump_table[RWIP_PREVENT_SLEEP_SET])((prv_slp_bit))
#endif
...
void rwip_prevent_sleep_clear(uint16_t prv_slp_bit);
 #else
typedef void (*rwip_prevent_sleep_clear_fn)(uint16_t);
 #define rwip_prevent_sleep_clear(prv_slp_bit) ((rwip_prevent_sleep_clear_fn)jump_table[RWIP_PREVENT_SLEEP_CLEAR])((prv_slp_bit))
 #endif
