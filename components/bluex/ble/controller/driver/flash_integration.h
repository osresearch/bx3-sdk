...
periph_err_t flash_program_operation_with_4byte_addr( uint8_t cmd, uint32_t offset, uint32_t length, uint8_t * buffer );

periph_err_t flash_erase_operation(uint8_t cmd,uint32_t addr,bool whole_chip);
periph_err_t flash_erase_operation_with_4byte_addr( uint8_t cmd, uint32_t addr, bool whole_chip );
...
periph_err_t flash_multi_read_32bits_operation_with_4byte_addr( uint32_t * data, uint16_t length, uint32_t addr );
