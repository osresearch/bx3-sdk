...
enum flash_commands{
    ...
    FLASH_PAGE_PROGRAM_WITH_4BYTE_ADDR = 0x12,
    ...
    FLASH_SINGLE_OUTPUT_FAST_READ = 0x0B,
    FLASH_SINGLE_OUTPUT_FAST_READ_WITH_4BYTE_ADDR = 0x0c,
    ...
    FLASH_SECTOR_ERASE_WITH_4BYTE_ADDR = 0x21,
    FLASH_32KB_BLOCK_ERASE = 0x52,
    FLASH_32KB_BLOCK_ERASE_WITH_4BYTE_ADDR = 0x5c,
    FLASH_64KB_BLOCK_ERASE = 0xd8,
    FLASH_64KB_BLOCK_ERASE_WITH_4BYTE_ADDR = 0xdc,
