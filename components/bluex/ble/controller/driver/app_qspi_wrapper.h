...
periph_err_t app_qspi_flash_program_wrapper_with_4byte_addr( uint8_t cmd, uint32_t addr, uint8_t * data, uint32_t length );
...
periph_err_t app_qspi_multi_read_32bits_wrapper_with_4byte_addr( uint32_t * data, uint16_t length, uint32_t addr );
