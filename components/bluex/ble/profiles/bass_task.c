...
{
    bxs_logln("bass enable_req_handler");
...
static int bass_batt_level_upd_req_handler(ke_msg_id_t const msgid,
                                            ...
                                            ke_task_id_t const src_id)
{
    bxs_logln("bass batt_level_upd_req_handler");
    int msg_status = KE_MSG_SAVED;
    uint8_t state = ke_state_get(dest_id);
...
static int gattc_att_info_req_ind_handler(ke_msg_id_t const msgid,
        ...
        ke_task_id_t const src_id)
{
    bxs_logln("bass gattc_att_info_req_ind_handler");
...
{
    bxs_logln("bass gattc_write_req_ind_handler");
...
static int gattc_read_req_ind_handler(ke_msg_id_t const msgid, struct gattc_read_req_ind const *param,
                                      ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    bxs_logln("bass gattc_read_req_ind_handler");
...
static int gattc_cmp_evt_handler(ke_msg_id_t const msgid,  struct gattc_cmp_evt const *param,
                                 ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    bxs_logln("bass gattc_cmp_evt_handler");
