    ...
    switch ( src_task_id ) {
        ...
        case ( TASK_ID_GAPC ): {
            ...
            if ( ( msgid >= GAPC_BOND_CMD ) &&
                ...
                //msg_pol = appm_get_handler( &utils_default_handler, msgid, param, src_id );
                //bxsh_logln("###################Call the Security Module\r\n");
                // Call the Security Module


                msg_pol = appm_get_handler( &app_sec_table_handler, msgid, param, src_id );
                // msg_pol = appm_get_handler( &bond_default_handler, msgid, param, src_id );
            }
