...
static uint8_t advData[] = {
    ...
    0x00,0x01,0x99,0x88,0x77,0x66,0x55,0xee,
...
static bx_err_t ble_msg_handle( s32 id, u32 msg, u32 param0, u32 param1 )
{
    switch( msg ) {
        ...
        case BXM_BLE_NOTIFY_ENABLED:
            ...
            break;
        case BXM_BLE_INDICATE:
            ble_send_data_indicate( ( u8 * )param0, param1, ble_svc.indicate_handle );
            break;
        case BXM_BLE_INDICATE_ENABLED:
            ble_indication_enabled( param0 );
            break;
...
static bx_err_t ble_property_set( s32 id, u32 property, u32 param0, u32 param1 )
{
    switch( property ) {
        ...
        case BXP_BLE_NOTIFY_HANDLE:
            ...
            break;
        case BXP_BLE_INDICATE_HANDLE:
            ble_svc.indicate_handle = param0;
            break;
...
bx_err_t us_ble_register( void )
{
    ...
    advData[4]=adv_mac_buf[5];
    advData[5]=adv_mac_buf[4];
    advData[6]=adv_mac_buf[3];
    advData[7]=adv_mac_buf[2];
    advData[8]=adv_mac_buf[1];
    advData[9]=adv_mac_buf[0];
