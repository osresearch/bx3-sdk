...
struct lcd_cmd lcd_cmd_hub[] = {
    ...
    { 0, 0xB5, 2, {0x09,0x09} },
    { 0, 0x60, 4, {0x38,0x0b,0x5b,0x56} },
    { 0, 0x63, 4, {0x3A,0xE0,0x5b,0x56} },
    
    { 0, 0x64, 6, {0x38,0x0d,0X72,0xdd,0x5b,0x56} },
    { 0, 0x66, 6, {0x38,0x11,0X72,0xe1,0x5b,0x56} },
    { 0, 0x68, 7, {0x3b,0x08,0X08,0x00,0x08,0x29,0x5B} },
    { 0, 0x6E, 32, {0x00,0x00,0X00,0x07,0x01,0x13,0x11,0x0B,0x09,0x16,0x15,0x1D,0x1E,0x00,0x00,0X00,0x00,0x00,0X00,0x1E,0x1D,0x15,0x16,0x0A,0x0C,0x12,0x14,0x02,0x08,0x00,0x00,0x00} },
    { 0, 0xBE, 1, {0x11} },
    { 0, 0x6C, 7, {0xCC,0x0C,0XCC,0x84,0xCC,0x04,0x50} },
    { 0, 0x7D, 1, {0x72} },
    { 0, 0x7E, 1, {0x38} },
    { 0, 0x70, 10, {0x02,0x03,0X09,0x05,0x0C,0x06,0x09,0x05,0x0C,0x06} },
 ...
 * @retval  :
-----------------------------------------------------------------------------*/
static bx_err_t dspl_open( void )
{
